...
Importa la estimación documentada de deuda neta consolidada del sector público (Tesoro + BCRA), sus componentes y porcentaje del PBI. La salida queda en `data/processed/consolidated_debt.csv`. Es una estimación privada reproducible, no una estadística oficial; la primera cobertura tabulada es `2025-Q2`.
